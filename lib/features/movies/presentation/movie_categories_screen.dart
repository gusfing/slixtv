...
class MovieCategoriesScreen extends ConsumerStatefulWidget {
  final void Function(VodItem movie)? onMovieTap;

  const MovieCategoriesScreen({super.key, this.onMovieTap});

  @override
  ConsumerState<MovieCategoriesScreen> createState() => _MovieCategoriesScreenState();
}

class _MovieCategoriesScreenState extends ConsumerState<MovieCategoriesScreen> {
  String _keySearch = "";
    ...
    return Scaffold(
      body: Container(
        ...
        child: SafeArea(
          child: Column(
            children: [
              // SFLIXTV Movie Categories header
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    const Icon(Icons.movie_filter_rounded, color: AppColors.primary, size: 26),
                    const SizedBox(width: 8),
                    const Text(
                      'Movie Categories',
                      style: TextStyle(
